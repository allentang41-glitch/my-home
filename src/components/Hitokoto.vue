<template>
  ...
  >
    ...
    <Transition name="el-fade-in-linear">
      <div class="open-music" v-show="openMusicShow" @click="store.musicOpenState = true">
...
.hitokoto {
  ...
  .open-music {
    ...
    .i-icon { width: 18px; height: 18px; display: block; margin-right: 8px; }
  ...
  .content {
    ...
    .from { margin-top: 10px; font-weight: bold; align-self: flex-end; font-size: 1.1rem; }
  }
}
</style>
